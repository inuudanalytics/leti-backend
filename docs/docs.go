...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/artisan/availability/overrides": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/properties/{id}/availability/block/{date}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
