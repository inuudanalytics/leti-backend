...
func artisanProfileRouter() *http.ServeMux {
	...
	mux.HandleFunc("GET /artisan/categories/all", artisanprofilesettings.GetAllCategories)
	mux.HandleFunc("GET /artisan/categories/{id}/variation-types", artisanprofilesettings.GetVariationTypes)
	...
	mux.HandleFunc("GET /artisan/{id}/categories", artisanprofilesettings.GetArtisanCategories)
	...
	mux.HandleFunc("GET /artisan/{id}/categories/{categoryId}/portfolio", artisanprofilesettings.GetArtisanPortfolioImages)
	...
	mux.HandleFunc("GET /artisan/{id}/services", artisanprofilesettings.GetArtisanServices)
